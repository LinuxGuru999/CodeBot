...
class AdaptiveScheduler:
    ...
    def tick(
        ...
        pressure = calculate_pressure(
            ...
            validating_count=pipeline.validating_count,
            triaged_count=pipeline.triaged_count,
            blocked_count=pipeline.blocked_count,
            deferred_count=pipeline.deferred_count,
            decompose_count=pipeline.decompose_count,
