...
LEGACY_ROLE_MAP: dict[str, str] = {
    ...
    "feature_decomposer": "implementation_planner",
    ...
    "goal_steering": "dependency_planner",
    "ui_improve": "ux_auditor",
    "release": "scheduler",
    "prompt_opt": "budget_controller",
    "alignment": "correctness_reviewer",
    "github_bot": "general_implementer",
    "gitsync": "general_implementer",
